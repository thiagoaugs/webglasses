...
public class UsuarioGrupo implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "ADMIN_USUARIOGRUPO_UGPID_GENERATOR", sequenceName = "ADMIN_USUARIOGRUPO_UGP_ID_SEQ", allocationSize = 1, initialValue = 10)
	...
	public UsuarioGrupo(Integer ugpId, Integer gpoId, String gpoNome, Integer usuId, String usuNome) {
	...
	/**
	 * @param ugpUsuario the ugpUsuario to set
	 */
	...
	/**
	 * @param ugpGrupo the ugpGrupo to set
	 */
