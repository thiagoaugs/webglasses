...
public class TipoPessoa implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "ADMIN_TIPO_PESSOA_TPSID_GENERATOR", sequenceName = "ADMIN_TIPO_PESSOA_TPS_ID_SEQ", allocationSize = 1, initialValue = 10)
	...
	/**
	 * @param tpsDescricao the tpsDescricao to set
	 */
