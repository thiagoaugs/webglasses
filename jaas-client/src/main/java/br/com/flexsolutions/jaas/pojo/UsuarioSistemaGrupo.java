...
public class UsuarioSistemaGrupo implements Serializable {
	...
	@Id
	@SequenceGenerator(name = "ADMIN_USUARIO_SISTEMA_GRUPO_USGID_GENERATOR", sequenceName = "ADMIN_USUARIO_SISTEMA_GRUPO_USG_ID_SEQ", allocationSize = 1, initialValue = 1)
