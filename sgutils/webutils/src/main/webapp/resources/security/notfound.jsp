		...
		<form id="frmError">
			<div class="errorPageMessage">
				...
				<div class="errorPageMessageDetails" >
					<fmt:message key="notfound.mensagem.acao" bundle="${bundle}"/><br/>
					[<a href="${pageContext.request.contextPath}/index.html"><fmt:message key="notfound.mensagem.voltar" bundle="${bundle}"/></a>]
				</div>
			</div>
		</form>	
	</body>
