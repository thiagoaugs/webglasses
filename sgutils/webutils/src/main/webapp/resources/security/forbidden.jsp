		...
		<form id="frmError">
			<div class="errorPageMessage">
				...
				<div class="errorPageMessageDetails" >
					<fmt:message key="forbidden.mensagem.acao" bundle="${bundle}"/><br/>
					[<a href="${pageContext.request.contextPath}/index.html"><fmt:message key="forbidden.mensagem.voltar" bundle="${bundle}"/></a>]
				</div>
			</div>
		</form>	
	</body>
