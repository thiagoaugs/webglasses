/**  
 * webglass-ejb - GenericHibernateDAO.java
 * 
 * Data de cria��o 28/05/2015
 *
 * Criado por DESENV10
 * 
 ...
 *
 */
package br.com.systemglass.persistenceutils.dao.generics.impl;
...
import br.com.systemglass.persistenceutils.dao.generics.GenericDAO;
import br.com.systemglass.persistenceutils.exception.ConstraintViolationException;
import br.com.systemglass.persistenceutils.utils.EntityUtils;

/**
 * Implementacao dos metodos de persistencia genericos
 * 
 * @author DESENV10
 * 
 * @param {@link <T>}
